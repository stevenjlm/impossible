...
document_set=[(['i','wish','i','had','a','car'],False),(['i','wish','i','had','a','airplane'],False),(['i','wish','i','had','a','pencil'],True),\
  (['i','wish','i','had','a','pencil'],True),(['i','wish','i','had','a','car'],False)]
all_text='i wish i had a car i wish i had a airplane i wish i had a pencil i wish i has a pencil i wish i had a car'
      
whole_set=document_set

document_set=whole_set[0:3]
test_set=whole_set[3:5]
